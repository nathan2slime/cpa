...
export const Question = ({ data: { type, question, options }, position, onChange }: QuestionTypeProps) => {
  ...
  return (
    <div className="w-full m-auto my-4 p-6 bg-white rounded-lg">
      <div className="flex gap-3 items-start justify-start">
        <Button variant="outline" className="font-bold flex-shrink-0 text-zinc-900" size="icon">
          {position + 1}
        </Button>
