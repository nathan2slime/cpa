    ...
    <div className="flex justify-center items-center min-h-screen">
      ...
      >
        <CardHeader>
          ...
          <CardDescription>Bem-vindo! Para continuar, preencha os campos abaixo.</CardDescription>
        </CardHeader>
        <form onSubmit={handleSubmit}>
          <CardContent>
            <div className="grid w-full items-center gap-4">
              <div className="flex flex-col space-y-1.5">
                ...
                <Input id="cpf" value={cpf} onChange={e => setCpf(e.target.value)} placeholder="Nenhum caractere especial" required />
              </div>
              <div className="flex flex-col space-y-1.5">
                <Label htmlFor="nome">Data de Nascimento</Label>
                <Input id="nome" value={nome} onChange={e => setNome(e.target.value)} type="password" placeholder="Somente números" required />
              </div>
          ...
          <CardFooter className="flex justify-end">
            <Button type="submit" variant="ghost" className="bg-[#1e3a8a] hover:bg-green-400 text-white" disabled={!nome || !cpf || !campus}>
              Continuar
            </Button>
          </CardFooter>
        </form>
