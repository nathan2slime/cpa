...
import { useUpdateForm } from "@/hooks/api-hooks";
...
export default function QuestionForm() {
  ...
  useEffect(() => {
    if (form?.id && debouncedTitle && debouncedTitle !== form.title) {
      updateForm.mutate({ id: form.id, title: debouncedTitle });
    }
  }, [debouncedTitle, form?.id]);
        ...
        <div className="max-w-4xl">
          <Card className="border-gray-200 shadow-sm">
            <CardHeader>
              ...
              <CardDescription>
                Crie e gerencie questões para seu formulário. Você pode
                adicionar questões de texto ou de múltipla escolha.
              </CardDescription>
            </CardHeader>
            <CardContent>
